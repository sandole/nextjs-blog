...
The code is in [cfv-scheduler](https://github.com/sandole/cfv-scheduler) if you want to fork it or adapt it for another education provider. The Skybridge docs are at [docs.skybridge.tech](https://docs.skybridge.tech).
