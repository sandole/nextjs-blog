...
**Working memory** — the cognitive scratchpad you use for active problem-solving — holds roughly **4 items** simultaneously. Not 7, as the often-cited Miller (1956) paper suggested. [Nelson Cowan's 2001 paper "The Magical Number 4 in Short-Term Memory"](https://pubmed.ncbi.nlm.nih.gov/11515286/) brought that number down, and subsequent research has confirmed it. Four items. That's it.

**The prefrontal cortex** — responsible for executive function, planning, and task management — is metabolically expensive. It fatigues. This is the neurological basis of decision fatigue, documented by Roy Baumeister in his work on [ego depletion](https://pmc.ncbi.nlm.nih.gov/articles/PMC6119549/) (Baumeister et al., 1998; Vohs et al., 2008): decision quality measurably degrades throughout the day as the prefrontal cortex depletes glucose and neurotransmitter reserves.
...
**Cognitive load theory** ([Sweller, 1988, "Cognitive Load During Problem Solving: Effects on Learning"](https://www.sciencedirect.com/science/article/abs/pii/0364021388900237)) gives us a framework. Your total cognitive bandwidth per unit time is roughly fixed, split between:
...
Herbert Simon (Nobel laureate, Carnegie Mellon), in his work with William Chase on [chess expertise and chunking](https://pubmed.ncbi.nlm.nih.gov/9709441/) (Chase & Simon, 1973; Gobet & Simon, 1998), estimated it takes approximately **10,000 hours** to build expert-level "chunks" — compressed mental models — in a domain. Your brain can realistically maintain deep chunk libraries in **3 to 5 domains** while keeping them current.
...
*References: All studies linked inline to their original papers or PubMed entries. Key sources: Mark, CHI 2008 ([PDF](https://ics.uci.edu/~gmark/chi08-mark.pdf)); Leroy, OBHDP 2009 ([ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/S0749597809000399)); Stothart et al., J. Exp. Psych. 2015 ([PubMed](https://pubmed.ncbi.nlm.nih.gov/26121498/)); Cowan, BBS 2001 ([PubMed](https://pubmed.ncbi.nlm.nih.gov/11515286/)); Maguire et al., PNAS 2000 ([DOI](https://www.pnas.org/doi/10.1073/pnas.070039597)); Sweller, Cognitive Science 1988 ([ScienceDirect](https://www.sciencedirect.com/science/article/abs/pii/0364021388900237)); Gobet & Simon, Memory 1998 ([PubMed](https://pubmed.ncbi.nlm.nih.gov/9709441/)); Baumeister et al. on ego depletion ([PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC6119549/)).*
