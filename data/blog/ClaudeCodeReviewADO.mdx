...
date: '2026-02-27'
tags: ['development', 'ai', 'azure-devops', 'security', 'devtools']
summary: Why enterprise teams on Azure DevOps are underserved by AI code review tools, and how I built a Claude-powered extension to fill the gap
---
...
I built [Claude Code Review](https://marketplace.visualstudio.com/items?itemName=JohnSeong.claude-code-review) as a native Azure DevOps pipeline task. The design philosophy is simple: **your code stays in your pipeline.**
...
Install from the [Azure DevOps Marketplace](https://marketplace.visualstudio.com/items?itemName=JohnSeong.claude-code-review). MIT licensed, open source, no strings.
